...
import 'package:codequest_etr/screens/game_screen4.dart';
...
class _ThirdStageState extends State<ThirdStage> {
  ...
  Widget build(BuildContext context) {
    ...
    double enemyLeft = MediaQuery.of(context).size.width - 245;
          ...
          actions: [
            TextButton(
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => FourthStage()),
                );
              },
              style: TextButton.styleFrom(
                backgroundColor: Colors.red,
